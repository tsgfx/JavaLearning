...
-- 案例：员工表
-- 基础字段：id 主键; create time; uodate time;
...
-- 字段：添加字段
alter table employee add qq varchar(13) comment 'QQ';

-- 字段：修改字段
alter table employee modify qq varchar(15) comment 'QQ';

-- 字段：修改字段属性
alter table employee change qq qq_num char(15) comment 'QQ';

-- 字段：删除字段
alter table employee drop qq_num;
...
-- 2. 为 emp 表的 所有字段插入值
-- 方式一
insert emp(username, password, name, gender, phone, job, salary, entry_date, image, create_time, update_time)
        values ('user1', '123456', '管理员', '1', '13888888888', 1, 5000, '2010-01-01', 'https://avatars.githubusercontent.com/u/10251060?s=200&v=4', now(), now());

-- 方式二
insert into emp values (null, 'user2', '123456', '管理员', '1', '13888888888', 1, 5000, '2010-01-01', 'https://avatars.githubusercontent.com/u/10251060?s=200&v=4', now(), now());

-- 3. 批量为 emp 表的 username, password, name, gender, phone  字段插入数据
insert into emp(username, password, name, gender, phone) values
('user3', '123456', '管理员', '1', '13888888888'),
('user4', '123456', '管理员', '1', '13888888888'),
('user5', '123456', '管理员', '1', '13888888888'),
('user6', '123456', '管理员', '1', '13888888888'),
('user7', '123456', '管理员', '1', '13888888888');
